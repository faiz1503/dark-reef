...
<body>
			...
			<div class="inner">
				<div class="shell">
					...
					<div id="content">
						...
						<!-- Begin Products -->
						<div id="products">
							<h2><span class="style4">Buah Lokal</span><span class="title-bottom">&nbsp;</span></h2>
							
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='4' and id='17'");
	if(mysqli_num_rows($sql) == 0){
		...
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Belimbing">
					<span class="title">Belimbing</span>
              ...
              ?>	</span></span></a>						</div>
						...
						<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='4' and id='18'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Duku">
					<span class="title">Duku</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
              ...
              ?>	
						...
						<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='4' and id='19'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
					...
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Kedondong">
					<span class="title">Kedondong</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='4' and id='20'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Salak">
					<span class="title">Salak</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='4' and id='21'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Jambu Air">
					<span class="title">Jambu Air</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                       <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='4' and id='22'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product last">
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Durian">
					<span class="title">Durian</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
						...
						<!-- Begin Products 2-->
						<div id="products">
							<h2><span class="style4">Buah Impor</span><span class="title-bottom">&nbsp;</span></h2>
							
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='5' and id='23'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Ceri Putih Amerika">
					<span class="title">Ceri Putih Amerika</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp.</span> <?php echo number_format($data['harga'],2,",",".");?></span></a>
                <?php   
              ...
              ?>	</span></span></a>						</div>
						...
						<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='5' and id='24'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Kelapa Thailand">
					<span class="title">Kelapa Thailand</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
						...
						<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='5' and id='25'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product last">
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Kiwi Emas New Zealand">
					<span class="title">Kiwi Emas New Zealand</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='5' and id='26'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Mangga India Royal Saffron">
					<span class="title">Mangga India Royal Saffron</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='5' and id='27'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Pisang Australia">
					<span class="title">Pisang Australia</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                       <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM buah where kategori='5' and id='28'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product last">
					<a href="detailproduk.php?kd=<?php echo $data['id'];?>" title="Pokat Meksiko">
					<span class="title">Pokat Meksiko</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
