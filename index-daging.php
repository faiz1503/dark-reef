...
<body>
			...
			<div class="inner">
				<div class="shell">
					...
					<div id="left-sidebar" class="sidebar">
						<ul>
							<li class="widget">
								<h2>Kategori Daging</h2>
								<div class="widget-entry">
									<ul>
										<li><a href="index-daging.php" title="Daging Ayam"><span>Daging Ayam</span></a></li>
										<li><a href="index-daging.php" title="Daging Sapi"><span>Daging Sapi</span></a></li>
									</ul>
								</div>
							</li>
							<li class="widget">
					...
					<div id="content">
						...
						<div id="products">
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM daging where kategori='1' and id='1'");
	if(mysqli_num_rows($sql) == 0){
		...
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk2.php?kd=<?php echo $data['id'];?>" title="Daging Ayam Cincang">
					<span class="title">Daging Ayam Cincang</span>
              ...
              ?>	</span></span></a>
						...
						<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM daging where kategori='1' and id='2'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk2.php?kd=<?php echo $data['id'];?>" title="Daging Ayam Dada">
					<span class="title">Daging Ayam Dada</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
              ...
              ?>	
						...
						<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM daging where kategori='1' and id='3'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
					...
					<a href="detailproduk2.php?kd=<?php echo $data['id'];?>" title="Daging Ayam Kaki">
					<span class="title">Daging Ayam Kaki</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM daging where kategori='1' and id='4'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk2.php?kd=<?php echo $data['id'];?>" title="Daging Ayam Sayap">
					<span class="title">Daging Ayam Sayap</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM daging where kategori='1' and id='5'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk2.php?kd=<?php echo $data['id'];?>" title="Daging Sapi Steak">
					<span class="title">Daging Sapi Steak</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM daging where kategori='1' and id='6'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product last">
					<a href="detailproduk2.php?kd=<?php echo $data['id'];?>" title="Daging Sapi Steak Striploin">
					<span class="title">Daging Sapi Steak Striploin</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
