...
<body>
    ...
    if (isset($_SESSION['items'])) {
        foreach ($_SESSION['items'] as $key => $val) {
            $query = mysqli_query($koneksi, "select buah.id, buah.nama_buah, buah.gambar, buah.harga from buah where buah.id = '$key'");
            ...
            ?>
                ...
                <td><center><?php echo $data['nama_buah']; ?></center></td>
    			...
    			<button type="button" class="button" onclick="window.location = 'detail.php';">
				<span><font color="#ffffff">Details Keranjang</font></span></button>
                    ...
                    <tr>
					<?php                  
					$query = mysqli_query($koneksi, "SELECT * FROM buah WHERE id='$_GET[kd]'");
					$data  = mysqli_fetch_array($query);
					?>
                        ...
                        <td><h3>:</h3></td>
						<td></td>
						<td><h3><?php echo $data['nama_buah']; ?></h3></td>
                        </tr>
                        <tr>
                        <td></td>
					...
					<!--	<p>
						...
						<td>
						<p align="right">
						<a href="cart.php?act=add&amp;barang_id=<?php echo $data['id']; ?>&amp;ref=detailproduk.php?kd=
