...
<body>
	...
	<div id="wrapper">
		...
		<div id="search">
			<div class="shell">
				<form action="proses1.php" method="post" accept-charset="utf-8">
					<div class="container">
    ...
    if (isset($_SESSION['items'])) {
        foreach ($_SESSION['items'] as $key => $val) {
            $query = mysqli_query($koneksi, "select sayur.id, sayur.nama_sayur, sayur.gambar, sayur.harga from sayur where sayur.id = '$key'");
            ...
            ?>
    			...
    			<button type="button" class="button" onclick="window.location = 'detail1.php';">
				<span><font color="#ffffff">Details Keranjang</font></span></button>
                    ...
                    <tr>
					<?php                  
					$query = mysqli_query($koneksi, "SELECT * FROM sayur WHERE id='$_GET[kd]'");
					$data  = mysqli_fetch_array($query);
					?>
                        ...
                        <td><h3>:</h3></td>
						<td></td>
						<td><h3><?php echo $data['nama_sayur']; ?></h3></td>
                        </tr>
                        <tr>
                        <td></td>
					...
					<!--	<p>
						...
						<td>
						<p align="right">
						<a href="cart.php?act=add&amp;barang_id=<?php echo $data['id']; ?>&amp;ref=detailproduk1.php?kd=
