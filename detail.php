...
<body>
    ...
    if (isset($_SESSION['items'])) {
        foreach ($_SESSION['items'] as $key => $val) {
            $query = mysqli_query($koneksi, "select buah.id, buah.nama_buah, buah.harga from buah where buah.id = '$key'");
            ...
            ?>
				...
				if($total == 0){
					...
					echo '<p><div align="right">
						<a href="index.php" class="btn btn-primary btn-lg">&laquo; Continue Shopping</a>
						</div></p>';
				} else {
					echo '
						...
						<p><div align="right">
						<a href="index.php" class="small button"><font color="white">Belanja Lagi</font></a>
