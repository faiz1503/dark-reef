...
<body>
				...
				<div class="shell">
					...
					<div id="content">
						...
						<div id="products">
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM sayur where kategori='1' and id='1'");
	if(mysqli_num_rows($sql) == 0){
		...
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk1.php?kd=<?php echo $data['id'];?>" title="Cabe">
					<span class="title">Cabe</span>
              ...
              ?>	</span></span></a>
						...
						<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM sayur where kategori='1' and id='2'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk1.php?kd=<?php echo $data['id'];?>" title="Jagung">
              ...
              ?>	
						...
						<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM sayur where kategori='1' and id='3'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
					...
					<a href="detailproduk1.php?kd=<?php echo $data['id'];?>" title="Kol">
					<span class="title">Kol</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM sayur where kategori='1' and id='4'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk1.php?kd=<?php echo $data['id'];?>" title="Sawi">
					<span class="title">Sawi</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM sayur where kategori='1' and id='5'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product">
					<a href="detailproduk1.php?kd=<?php echo $data['id'];?>" title="Terong">
					<span class="title">Terong</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
              ...
              ?>	
							...
							<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM sayur where kategori='1' and id='6'");
	if(mysqli_num_rows($sql) == 0){
		echo "Tidak ada produk!";
	}else{
		while($data = mysqli_fetch_assoc($sql)){
                    ?>
					<div class="product last">
					<a href="detailproduk1.php?kd=<?php echo $data['id'];?>" title="Tomat">
					<span class="title">Tomat</span>
                        <span class="title"><?php echo $data['nama']; ?></span>
                        <img src="css/images/<?php echo $data['gambar']; ?>" width="150" height="150" />
						<span class="price"><span>Rp. </span><?php echo number_format($data['harga'],2,",",".");?></span>
                <?php   
